        ...
        <div className={`bgDiv ${styles.bgDiv}`}>
            <div className={`brandPanels ${styles.brandPanels}`}>
                <div className={`letterContainer ${styles.letterContainer}`}>
                    ...
                    <h1 className={`letterPanel letterPanelOther ${styles.letters}`}>oo</h1>
                    <h1 className={`letterPanel letterPanelOther ${styles.letters}`}>tr</h1>
                    <h1 className={`letterPanel letterPanelOther ${styles.letters}`}>ik</h1>
                    <h1 className={`letterPanel letterPanelOther ${styles.letters}`}>.s</h1>
                </div>
            </div>
            ...
            <div className={`wipePanel ${styles.wipePanel}`}>
